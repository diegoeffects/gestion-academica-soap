...
public class MateriaInscripcionCarreraDTO {
	...
	public MateriaInscripcionCarreraDTO(String idComision, String materia, String docente, String turno, String idDia,
			String diaHorario) {
		super();
