...
public class ComisionPlanillaWS {
	...
	public ComisionPlanillaWS(int idMateria, String materia, String comision, String docente, String horarioCursada, String fechaMesa, int anioCarrera) {
		super();
	...
	public int compareTo(ComisionPlanillaWS o){
