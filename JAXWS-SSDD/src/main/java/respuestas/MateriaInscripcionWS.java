...
public class MateriaInscripcionWS {
	...
	public MateriaInscripcionWS(int idMateria, String materia, String comision, String docente, String horarioCursada, String fechaMesa, int anioCarrera) {
		super();
	...
	public int compareTo(MateriaInscripcionWS o){
